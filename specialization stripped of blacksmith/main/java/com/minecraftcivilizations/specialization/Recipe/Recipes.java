...
public class Recipes {
    ...
    public static void registerRecipes(boolean reloading) {
        ...
        // ----- CUSTOM "RAIL" RECIPE -----
        // Depends on the armor_plate_iron custom item registered by the BlacksmithOverhaul
        // plugin. If that plugin isn't loaded, skip the recipe rather than NPE.
        com.minecraftcivilizations.specialization.CustomItem.CustomItem armorPlateIron =
                CustomItemManager.getInstance().getCustomItem("armor_plate_iron");
        if (armorPlateIron != null) {
            ...
            rail.setIngredient('I', new RecipeChoice.ExactChoice(armorPlateIron.createItemStack()));
